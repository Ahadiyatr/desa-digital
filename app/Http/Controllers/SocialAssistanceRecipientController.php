...
use App\Http\Requests\SocialAssistanceRecipientStore;
...
class SocialAssistanceRecipientController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Penerima Bantuan Social Berhasil Diambil', SocialAssistanceRecipientResource::collection($socialAssistanceRecipients), 200);
        } catch (\Exception $e) {
    ...
    public function getAllPaginated(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Penerima Bantuan Social Berhasil Diambil',PaginateResource::make($socialAssistanceRecipients, SocialAssistanceRecipientResource::class), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function store(SocialAssistanceRecipientStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Penerima Bantuan Social Berhasil Dibuat', new SocialAssistanceRecipientResource($socialAssistanceRecipient), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function show(string $id)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Bantuan Sosial Berhasil Ditemukan', new SocialAssistanceRecipientResource($socialAssistanceRecipient), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function update(SocialAssistanceRecipientUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Penerima Bantuan Social Berhasil Diupdate', new SocialAssistanceRecipientResource($socialAssistanceRecipient), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Penerima Bantuan Social Berhasil Dihapus', new SocialAssistanceRecipientResource($socialAssistanceRecipient), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
